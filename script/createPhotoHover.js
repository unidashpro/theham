export const createPhotoHover = url => {
    return `<div class="hidden-block">
                                    <div class="hidden-links-wrapper">
                                        <a href="#" class="hidden-link">
                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="chain">
                                    ...
                                    <div class="hidden-text-wrapper">
                                        ...
                                        <p>${url.slice(0, url.lastIndexOf('/'))}</p>
                                    </div>
                  </div>`;
};
